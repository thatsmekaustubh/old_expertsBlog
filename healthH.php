...
<div id="Layer3">
  ...
  <table width="200" border="0" align="center">
    ...
    <tr>
      <td bgcolor="#9BBC51"><div align="center">
        <form id="form2" name="form2" method="post" action="http://localhost/ExpertsBlog/listing.php">
          <input name="type" type="hidden" id="type" value="Blog" />
                        ...
                        <input name="category" type="hidden" id="category" value="Health" />
        </form>
      </div></td>
    </tr>
  </table>
...
<div id="Layer4">
  <div id="layer">
    ...
    <table width="200" border="0" align="center">
      ...
      <tr>
        <td bgcolor="#9BBC54"><div align="center">
		 <form id="form2" name="form2" method="post" action="http://localhost/ExpertsBlog/listing.php">
...
<div id="Layer9"><img src="/ExpertsBlog/images/health .jpg" width="195" height="160" /></div>
<div id="Layer10"><img src="/ExpertsBlog/images/images.jpg" width="148" height="117" /></div>
<div id="Layer11"><img src="images/health .jpg" width="400" height="300" /></div>
</body>
</html>
