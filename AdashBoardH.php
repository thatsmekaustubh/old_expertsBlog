...
<div id="Layer2"><a href="http://localhost/ExpertsBlog/index.php"><img src="/ExpertsBlog/images/home.gif" alt="home" width="41" height="46" border="0" align="bottom" longdesc="http://localhost/ExpertsBlog/index.php" /></a></div>
<div id="Layer4">
  <div align="right">
  <?php 
session_start();
...
<div id="Layer5">
  <table width="570" height="25" border="0" bordercolor="#91604E">
    <tr>
      <td height="21" bgcolor="#9BBC54"><span class="style4">Blogs by me . . . </span></td>
    </tr>
  </table>
</div>
<div id="Layer7">
  <form id="form1" name="form1" method="post" action="http://localhost/ExpertsBlog/quickPost.php">
    <table width="356" border="0">
      <tr>
        <td colspan="5" bgcolor="#9BBC54"><div align="center"><span class="style4">Quick Post</span></div></td>
      </tr>
      <tr>
...
//  echo $id;
  ...
  echo "</td>";
  echo "<td>";
  echo "<form action='http://localhost/ExpertsBlog/blogEdit.php' method='post'>";
  echo "<input type='hidden' name='id' value='$id' />";
  echo "<input type='hidden' name='type' value='Blog' />";
...
<div id="Layer13">
  <div id="layer">
    <table width="570" height="25" border="0" bordercolor="#91604E">
      <tr>
        <td height="21" bgcolor="#9BBC54"><span class="style4">Articles by me . . . </span></td>
      </tr>
    </table>
  </div>
</div>
...
//		  $width=$row['Width'];
		...
		echo "<img src='upload/".$src."' width='230' height='230' alt='$alt' />";
		?>
          </div></td>
        </tr>
        <tr>
...
echo "<font color='white'>".$fname." ".$lname; 
mysql_close($con); ?>
          </div></td>
        </tr>
        <tr>
...
mysql_close($con); ?>
        ...
        <tr>
          <td><div align="center"><a href="http://localhost/ExpertsBlog/dashBoardP.php"></a><a href="http://localhost/ExpertsBlog/dashBoardP.php"></a><a href="http://localhost/ExpertsBlog/dashBoardP.php">Change Photo</a></div></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
