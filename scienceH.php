      ...
      <td bgcolor="#9BBC54"><div align="center">
        <form id="form2" name="form2" method="post" action="http://localhost/ExpertsBlog/listing.php">
          <input name="type" type="hidden" id="type" value="Blog" />
                        ...
                        <input name="category" type="hidden" id="category" value="Science" />
        </form>
      </div></td>
    </tr>
  </table>
...
<div id="Layer9"><img src="/ExpertsBlog/images/images3.jpg" width="82" height="140" /></div>
<div id="Layer10"><img src="images/images3.jpg" width="233" height="206" /></div>
</body>
</html>
